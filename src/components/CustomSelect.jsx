...
export const CustomSelect = ({
  ...
  return (
    <div
      ref={selectRef}
      className={`relative h-[42px] rounded-xl ${className} ${isOpen ? "rounded-b-none" : ""}`}
    >
      <button
        onClick={toggleOpen}
      ...
      >
        ...
        <svg
          ...
          className={`absolute top-1/2 -translate-y-1/2 right-[15px] duration-200 ${isOpen ? "rotate-180" : ""}`}
        >
          <path
