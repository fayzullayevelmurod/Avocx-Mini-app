  ...
  return (
    <div className="bg-charcoal p-[1px] rounded-[25px] border border-iron overflow-hidden">
      <div className="relative -m-[1px]">
        ...
        {actions && (
          <>
            <button className="absolute top-2 right-2 w-[41px] h-[41px] backdrop-blur-4 bg-dark-glass rounded-[15px] flex items-center justify-center">
              <img src="images/icons/pen.svg" alt="pen" />
            </button>
            <button className="absolute top-2 left-2  w-[41px] h-[41px] rounded-[15px] backdrop-blur-4 bg-dark-glass flex items-center justify-center z-10">
      ...
      <div className="pt-[9px] pb-1">
        ...
        <div className="flex gap-1 mt-[7px] pl-1">
          <Button
            className="!h-[39px] max-w-[126px] w-full !bg-[#232323]"
            gray={true}
          >
