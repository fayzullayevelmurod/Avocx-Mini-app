      ...
      <div className="px-[13px]">
          ...
          <div className="bg-[#272727] h-[70px] rounded-15 pl-6 pr-[25px] py-[17px] flex items-center justify-between">
            <div>
              <div className="flex items-center gap-[7px]">
                ...
                <span className="font-bold leading-[12px]">Онлайн оплата</span>
              </div>
        ...
        <div className="mt-3 bg-charcoal text-center pt-[13px] p-3 rounded-15">
          ...
          <p className="text-[10px] font-medium text-[#B1B1B1] leading-[114%]">
            ...
            Telegram – <span className="text-[#E679FF]">Fragment.com</span>, но
            для того чтобы купить там, вам понадобится подключить внутренний TG
            кошелёк <span className="text-[#E679FF]">@wallet</span> и
            криптовалюта TON на нём.
          </p>
        </div>
      </div>
    </div>
