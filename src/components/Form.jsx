...
export const InputForm = ({ type = 'text', placeHolder }) => {
  return (
    <input
      className='w-full h-[45px] py-2 px-[10px] bg-dark rounded-[15px] placeholder:text-iron text-sm text-white'
      type={type}
...
export const UploadFile = () => {
  return (
    <div className='flex items-center justify-center gap-[7px] w-full h-[45px] py-2 px-[10px] bg-dark rounded-[15px]'>
      ...
      <span className='text-15'>Загрузить текстовым файлом</span>
    </div>
  );
};
