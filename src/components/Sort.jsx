...
export const Sort = ({
  ...
  return (
    <div
      className={`relative flex-[1_1_30px] rounded-15 ${
        isOpen ? "shadow-option-shadow" : ""
      }`}
    >
      <button
        className={`flex-1 justify-between duration-300 flex w-full items-center text-15 gap-[10px] rounded-15 h-[55px] pr-4 bg-carbon pl-[16px] ${
      ...
      <ul
        className={`absolute left-0 top-full duration-300 z-50 w-full bg-carbon pt-[2px] p-[15px] rounded-b-[20px] pb-4 -mt-[6px] ${
          isOpen
