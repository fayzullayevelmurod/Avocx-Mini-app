      ...
      <header className="py-5 px-[35px]">
        <div className="max-w-[368px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-[2px] translate-x-5">
            ...
            <Link
              className="text-xs font- text-base-white font-semibold"
              to="#!"
            >
              @norffas
            </Link>
          </div>
          <div className="bg-charcoal p-1 pl-[9px] rounded-base flex items-center gap-2 h-[31px]">
            <img src="images/icons/ton-icon.svg" alt="" />
            <span className="text-15 font-medium">0</span>
            <img src="images/icons/increment.svg" alt="" />
          </div>
        </div>
      </header>
      {/* media menu */}
